...
public class purchase extends javax.swing.JFrame {
    ...
    public void Vendor()
    {
        ...
        try {
            pst = (PreparedStatement) con.prepareStatement("select Distinct name from vendor");
            rs = pst.executeQuery();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtvendor, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(129, 129, 129))
            .addGroup(layout.createSequentialGroup()
                .addGap(14, 14, 14)
